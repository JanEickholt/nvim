...
return {
  ...
  -- Anchor tag (i.e. link)
  s(
    { trig = "aa", regTrig = true, wordTrig = false, snippetType = "autosnippet" },
    fmt(
      [[
          <a href={} class="{}{}">{}</a>
        ]],
  ...
  -- SPAN ELEMENT
  s(
    { trig = "([^%l])spp", regTrig = true, wordTrig = false, snippetType = "autosnippet" },
    fmt(
      [[
          {}<span class="{}">{}</span>
        ]],
  ...
  -- Inline paragraph
  s(
    { trig = "pii", snippetType = "autosnippet" },
    fmt(
      [[
          <p{}>{}</p>
        ]],
  ...
  -- IMG
  s(
    { trig = "imgg", snippetType = "autosnippet" },
    fmt(
      [[
          <img src="{}" alt="{}" class="{}"/>
        ]],
  ...
  s({ trig = "bcc", snippetType = "autosnippet" }, t("-ml-1 w-6 h-6 text-gray-600 shrink-0")),
  -- Unordered list
  s(
    { trig = "ull", snippetType = "autosnippet" },
    fmt(
      [[
          <ul{}>
            {}
  ...
  s(
    { trig = "dii", snippetType = "autosnippet" },
    fmt(
      [[
          <div id="{}">
            {}
